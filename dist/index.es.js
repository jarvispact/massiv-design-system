...
var Box = React.forwardRef(function (_a, ref) {
    ...
    return React.createElement(as, __assign(__assign({}, omit(omitProps$2, props)), { className: newClassName, ref: ref }), children);
});
Box.displayName = 'Box';
...
var Heading = React.forwardRef(function (_a, ref) {
    ...
    return React.createElement(as, __assign(__assign({}, omit(omitProps$1, props)), { className: newClassName, ref: ref }), children);
});
...
var Text = React.forwardRef(function (_a, ref) {
    ...
    var newClassName = cx(defaultStyle, dynamicStyle, className);
    return React.createElement(as, __assign(__assign({}, omit(omitProps, props)), { className: newClassName, ref: ref }), children);
});
