...
var StyledH3 = _styledComponents.default.h3(_templateObject(), function (props) {
  ...
  return props.theme.fonts.h3.weights[props.massivWeight] || props.massivWeight || props.theme.fonts.h3.weights.m;
}, function (props) {
...
var H3 = function H3(_ref) {
  ...
  return _react.default.createElement(StyledH3, _extends({
    massivWeight: weight,
    massivScale: scale,
    massivColor: color
  }, otherProps), children);
