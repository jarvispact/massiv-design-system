...
var _withTheme = _interopRequireDefault(require("../theme/with-theme"));
...
var LoadingIndicator = function LoadingIndicator(_ref) {
  ...
  return _react["default"].createElement("svg", {
    ...
    x: "0px",
    y: "0px",
    width: theme.fontSizes[fontSize] || fontSize,
    height: theme.fontSizes[fontSize] || fontSize,
    viewBox: "0 0 100 100",
...
var _default = (0, _withTheme["default"])(LoadingIndicator);
