...
var Box = function () {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("div", { className: css({ color: theme.color.error700 }) }, "hello emotion"),
        React__default['default'].createElement("button", { onClick: function () { return setTheme(__assign(__assign({}, theme), { color: __assign(__assign({}, theme.color), { error700: '#ff0000' }) })); } }, "change theme")));
};
