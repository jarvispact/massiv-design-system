...
// @ts-ignore
var _a = styledComponents, styled = _a.default, css = _a.css, createGlobalStyle = _a.createGlobalStyle, keyframes = _a.keyframes;
...
var curry = function (f) {
    ...
    return (args.length >= f.length ? f.apply(void 0, args) : function () {
        ...
        return curry.apply(void 0, __spreadArray([f.bind.apply(f, __spreadArray([f], args))], next));
    });
};

var omit = curry(function (propertyList, obj) {
...
var path = curry(function (path, obj) {
    if (obj === void 0) { obj = {}; }
    // @ts-ignore
    return path.reduce(function (accum, pathKey) {
        if (isNil(accum))
            return undefined;
...
var getMediaQueryForBreakpoint = function (breakpoint, cssArray) {
    var mediaQuery = css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n        @media screen and (min-width: ", ") {\n            ", "\n        }\n    "], ["\n        @media screen and (min-width: ", ") {\n            ", "\n        }\n    "])), breakpoint, cssArray.join('\n'));
...
var buildCss = function (propertyConfigList) { return function (props) {
    ...
    var allCss = __spreadArray(__spreadArray([], cssArray), mediaQueryArray).filter(Boolean);
    return allCss.length ? allCss.join('\n') : undefined;
}; };
var templateObject_1$2;

var defaultBlacklist = ['color', 'width', 'height', 'spacing', 'display', 'fontFamily', 'fontSize'];
var shouldForwardProp = function (name, defaultValidator) { return (defaultBlacklist.includes(name) ? false : defaultValidator(name)); };
var createShouldForwardProp = function (blacklist) { return function (name, defaultValidator) {
    return blacklist.includes(name) ? false : defaultValidator(name);
}; };

var boxConfig = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], colorConfig), borderConfig), paddingConfig), marginConfig), flexConfig), positionConfig), displayConfig), overflowConfig), fontConfig), shadowConfig), gridConfig), widthConfig), heightConfig);
var createBox = function (options) {
...
var systemConfig = __spreadArray(__spreadArray([], boxConfig), imageConfig);
var ImageBox = createBox({ forwardPropertyBlacklist: ['color', 'spacing', 'display', 'fontFamily', 'fontSize'], systemConfig: systemConfig });
var Image = function (props) { return r__default['default'].createElement(ImageBox, __assign({ as: "img" }, props)); };
...
var createCustomTheme = function (theme) { return theme; };

/* eslint-disable @typescript-eslint/no-explicit-any */
var ThemeContext = r__default['default'].createContext({
    theme: defaultTheme,
    setTheme: function () { },
});
var ThemeProvider = function (_a) {
    var theme = _a.theme, children = _a.children;
    var _b = r$1.useState(theme), activeTheme = _b[0], setActiveTheme = _b[1];
    var context = {
        theme: activeTheme,
        setTheme: setActiveTheme,
    };
    return (r__default['default'].createElement(ThemeContext.Provider, { value: context },
        r__default['default'].createElement(Le, { theme: context.theme }, children)));
};
var useTheme = function () { return r$1.useContext(ThemeContext); };

var GlobalStyle = createGlobalStyle(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    /* http://meyerweb.com/eric/tools/css/reset/ \n    v2.0 | 20110126\n    License: none (public domain)\n    */\n\n    html, body, div, span, applet, object, iframe,\n    h1, h2, h3, h4, h5, h6, p, blockquote, pre,\n    a, abbr, acronym, address, big, cite, code,\n    del, dfn, em, img, ins, kbd, q, s, samp,\n    small, strike, strong, sub, sup, tt, var,\n    b, u, i, center,\n    dl, dt, dd, ol, ul, li,\n    fieldset, form, label, legend,\n    table, caption, tbody, tfoot, thead, tr, th, td,\n    article, aside, canvas, details, embed, \n    figure, figcaption, footer, header, hgroup, \n    menu, nav, output, ruby, section, summary,\n    time, mark, audio, video {\n        margin: 0;\n        padding: 0;\n        border: 0;\n        font-size: 100%;\n        font-family: ", ";\n        vertical-align: baseline;\n        box-sizing: border-box;\n    }\n    /* HTML5 display-role reset for older browsers */\n    article, aside, details, figcaption, figure, \n    footer, header, hgroup, menu, nav, section {\n        display: block;\n    }\n    ol, ul {\n        list-style: none;\n    }\n    blockquote, q {\n        quotes: none;\n    }\n    blockquote:before, blockquote:after,\n    q:before, q:after {\n        content: '';\n        content: none;\n    }\n    table {\n        border-collapse: collapse;\n        border-spacing: 0;\n    }\n    input, textarea {\n        box-sizing: border-box;\n        font-family: ", ";\n    }\n    input:focus, button:focus, textarea:focus {\n        outline: solid 1.5px ", ";\n    }\n"], ["\n    /* http://meyerweb.com/eric/tools/css/reset/ \n    v2.0 | 20110126\n    License: none (public domain)\n    */\n\n    html, body, div, span, applet, object, iframe,\n    h1, h2, h3, h4, h5, h6, p, blockquote, pre,\n    a, abbr, acronym, address, big, cite, code,\n    del, dfn, em, img, ins, kbd, q, s, samp,\n    small, strike, strong, sub, sup, tt, var,\n    b, u, i, center,\n    dl, dt, dd, ol, ul, li,\n    fieldset, form, label, legend,\n    table, caption, tbody, tfoot, thead, tr, th, td,\n    article, aside, canvas, details, embed, \n    figure, figcaption, footer, header, hgroup, \n    menu, nav, output, ruby, section, summary,\n    time, mark, audio, video {\n        margin: 0;\n        padding: 0;\n        border: 0;\n        font-size: 100%;\n        font-family: ", ";\n        vertical-align: baseline;\n        box-sizing: border-box;\n    }\n    /* HTML5 display-role reset for older browsers */\n    article, aside, details, figcaption, figure, \n    footer, header, hgroup, menu, nav, section {\n        display: block;\n    }\n    ol, ul {\n        list-style: none;\n    }\n    blockquote, q {\n        quotes: none;\n    }\n    blockquote:before, blockquote:after,\n    q:before, q:after {\n        content: '';\n        content: none;\n    }\n    table {\n        border-collapse: collapse;\n        border-spacing: 0;\n    }\n    input, textarea {\n        box-sizing: border-box;\n        font-family: ", ";\n    }\n    input:focus, button:focus, textarea:focus {\n        outline: solid 1.5px ", ";\n    }\n"])), function (props) { return props.theme.fontFamily.sans; }, function (props) { return props.theme.fontFamily.sans; }, function (props) { return props.theme.color.primary500; });
...
exports.flexConfig = flexConfig;
exports.fontConfig = fontConfig;
exports.gridConfig = gridConfig;
exports.heightConfig = heightConfig;
exports.keyframes = keyframes;
exports.marginConfig = marginConfig;
exports.overflowConfig = overflowConfig;
exports.paddingConfig = paddingConfig;
exports.positionConfig = positionConfig;
exports.shadowConfig = shadowConfig;
exports.shouldForwardProp = shouldForwardProp;
exports.styled = styled;
exports.useTheme = useTheme;
exports.widthConfig = widthConfig;
