...
export declare const Heading: React.ForwardRefExoticComponent<Pick<HTMLAttributesWithoutStyleProps<React.HTMLAttributes<HTMLHeadingElement>> & Partial<{
    ...
    children: React.ReactNode;
}, string | number> & React.RefAttributes<HTMLHeadingElement>>;
export {};
