...
var StyledH4 = _styledComponents.default.h4(_templateObject(), function (props) {
  ...
  return props.theme.fonts.h4.weights[props.massivWeight] || props.massivWeight || props.theme.fonts.h4.weights.m;
}, function (props) {
...
var H4 = function H4(_ref) {
  ...
  return _react.default.createElement(StyledH4, _extends({
    massivWeight: weight,
    massivScale: scale,
    massivColor: color
  }, otherProps), children);
